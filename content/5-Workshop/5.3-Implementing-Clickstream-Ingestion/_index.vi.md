...
![Sự kiện bucket S3 RAW](/images/5.workshop/aws-s3-clickstream-ingest-events.png)

---

## 5.3.3 Thiết kế Lambda Ingest - `clickstream-lambda-ingest`

![Lambda Ingest](/images/5.workshop/aws-lambda-clickstream-ingest-config.png)
...
![Route POST /clickstream](/images/5.workshop/aws-apigw-clickstream-routes.png)
